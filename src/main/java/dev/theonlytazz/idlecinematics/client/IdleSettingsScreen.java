...
public final class IdleSettingsScreen extends Screen {
    ...
    protected void init() {
        ...
        y += 24;
        addRenderableWidget(CycleButton.<ClientConfig.ShotMode>builder(value -> Component.translatable("idlecinematics.shot_mode." + value.name().toLowerCase()))
                .withValues(List.of(ClientConfig.ShotMode.values())).withInitialValue(ClientConfig.SHOT_MODE.get())
